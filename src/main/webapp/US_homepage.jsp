<%-- 
    Document   : US_homepage
    Created on : 17 gen 2025, 16:42:35
    Author     : Salvatore
--%>
                                ...
                                <nav class="navbar navbar-expand-lg has-megamenu" aria-label="Navigazione principale">
                                    ...
                                    <div class="navbar-collapsable" id="navC1" style="display: none;">
                                        ...
                                        <div class="menu-wrapper">
                                            <ul class="navbar-nav">
                                                <li class="nav-item active"><a class="nav-link active" href="US_homepage.jsp" aria-current="page">
                                                        <span>
                                                ...
                                                <li class="nav-item"><a class="nav-link" href="US_archivio.jsp">
                                                        <span>
                    ...
                    <div class="card-wrapper">
                        <div class="card card-bg mb-6">
                            <div class="card-body">
                                ...
                                <h5 class="card-title h5">Questionario in corso</h5>
                                <p class="card-text font-serif">Controlla lo stato dell'ultimo questionario che ti è stato assegnato.</p>
                                <a class="simple-link" href="US_questionario.jsp">Clicca qui <span class="visually-hidden"></span></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-wrapper">
                        <div class="card card-bg mb-6">
                            <div class="card-body">
                                ...
                                <p class="card-text font-serif">Visualizza tutti i questionari che hai già completato e quello in corso.</p>
                                <a class="simple-link" href="US_archivio.jsp">Clicca qui <span class="visually-hidden"></span></a>
                            </div>
                        </div>
                    </div>
                </div>
